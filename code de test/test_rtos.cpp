...
// ─── TÂCHE FREEERTOS — AFFICHAGE SUR CORE 1 ───────────────────────────────────
...
void setup() {
    ...
    // Lance les tâches sur les cores 0 et 1
...
void loop()
{
    // La loop() reste vide car tout est géré par les tâches FreeRTOS
}